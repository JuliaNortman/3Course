...
public class ExtendedEuclidTest {
    ...
    public void extendedEuclid() {
        ...
        assertEquals(new ExtendedEuclid.Result(BigInteger.ONE, new BigInteger("-36166243"), new BigInteger("93485")), r);
        ...
        assertEquals(new ExtendedEuclid.Result(BigInteger.valueOf(2), new BigInteger("53018476281"), new BigInteger("-1116485")), r);
