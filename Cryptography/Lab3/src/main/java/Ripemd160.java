...
public class Ripemd160 {
    ...
    public static byte[] getHash(byte[] msg) {
        ...
        // array are copied into positions destPos through destPos + length - 1, respectively, of the destination array.
        System.arraycopy(msg, off, block, 0, msg.length - off);
        off = msg.length % block.length;
        block[off] = (byte)0x80; //add bit '1'
        off++;
        //add bits '0'
        ...
        // Int32 array to bytes in little endian (from low bits to high)
